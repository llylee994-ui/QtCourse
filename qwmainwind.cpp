...
#include <cstddef>   // 确保有 std::size_t
    ...
    ui(new Ui::QWMainWind)
{
    ...
    QAction *actAbout = new QAction(QIcon(":/images/images/20.ico"), tr("About"), this);
    connect(actAbout, &QAction::triggered, this, &QWMainWind::on_actAbout_triggered);
